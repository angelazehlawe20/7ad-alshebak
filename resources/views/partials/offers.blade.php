        ...
        <div class="row gy-4">
            ...
            <div class="col-lg-4 col-md-6 col-6">
                <div class="card h-100 shadow">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            <h3 class="card-title h4 mb-2">{{ app()->getLocale() == 'ar' ? $offer->title_ar : $offer->title_en }}</h3>
                        </div>
                        <p class="card-text">{{ app()->getLocale() == 'ar' ? $offer->description_ar : $offer->description_en }}</p>
                        <p class="card-text"><i class="far fa-calendar-alt me-2"></i>{{ __('offers.valid_until') }}:
                            {{ $offer->valid_until->format('Y-m-d h:i A') }}</p>
                        <p class="card-text"><small class="text-muted"><i class="fas fa-tag me-2"></i>{{
                                __('offers.category') }}: {{ app()->getLocale() == 'ar' ? $offer->category->name_ar : $offer->category->name_en }}</small></p>
