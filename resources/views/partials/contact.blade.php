...
<section id="contact" class="contact section">
    ...
    <div class="container section-title" data-aos="fade-up">
        <p><span>{{ __('contact.contact')}}</span> <span class="description-title">{{ __('contact.us')}}</span></p>
    ...
    <div class="container px-4">
        <div class="row gy-4">
            ...
            <div class="col-md-6">
                <div class="info-item d-flex align-items-center" data-aos="fade-up" data-aos-delay="500">
                    ...
                    <div>
                        <h3>{{ __('contact.opening_hours') }}<br></h3>
        ...
        <form action={{route('contact.store')}} method="POST" class="php-email-form" data-aos="fade-up" data-aos-delay="600">
            ...
            <div class="row gy-4">
                ...
                <div class="col-md-6">
                    <input type="text" name="name_{{ app()->getLocale() }}" class="form-control ps-3" placeholder="{{ __('contact.your_name') }}" required="">
                </div>

                <div class="col-md-6 ">
                    <input type="email" class="form-control ps-3" name="email" placeholder="{{ __('contact.your_email') }}">
                </div>

                <div class="col-md-12">
                    <input type="text" class="form-control ps-3" name="subject_{{ app()->getLocale() }}" placeholder="{{ __('contact.subject') }}" required="">
                </div>

                <div class="col-md-12">
                    <textarea class="form-control ps-3" name="message_{{ app()->getLocale() }}" rows="6" placeholder="{{ __('contact.message') }}" required=""></textarea>
                </div>

                <div class="col-md-12 text-center">
                    <div class="loading">{{ __('contact.loading') }}</div>
                    <div class="error-message">{{ __('contact.error_message') }}</div>
                    <div class="sent-message">{{ __('contact.sent_message') }}</div>
