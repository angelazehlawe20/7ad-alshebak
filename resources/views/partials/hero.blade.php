...
<section id="hero" class="hero section position-relative"
    style="min-height: 100vh; padding: 0; margin: 0; width: 100vw; left: 0; right: 0;">
    ...
    <div class="swiper background-swiper position-absolute"
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide"
                style="background-image: url('{{ asset($image->image_path) }}'); background-size: cover; background-position: center; margin: 0; padding: 0;">
                <div class="overlay position-absolute w-100 h-100"
                    style="background: rgba(0, 0, 0, 0.0); top: 0; left: 0;"></div>
            </div>
            @endforeach
            @else
            <div class="swiper-slide"
                style="background-image: url('{{ asset('/assets/img/hexagons/background.png') }}'); background-size: cover; background-position: center; margin: 0; padding: 0;">
                <div class="overlay position-absolute w-100 h-100"
                    style="background: rgba(0, 0, 0, 0.1); top: 0; left: 0;"></div>
            </div>
            @endif
        </div>
        <style>
