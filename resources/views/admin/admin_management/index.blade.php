        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-12 d-flex justify-content-between align-items-center">
                    <h1 class="m-0" style="color: #8B7355"><i class="fas fa-users me-2"></i> {{ __('admins.list_title') }}</h1>
                    <a href="{{ route('admin.admins.create') }}" class="btn" style="background-color: #8B7355; color: white;">
