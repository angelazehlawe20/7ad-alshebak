    ...
    <div class="d-flex flex-column h-100">
        ...
        <nav class="nav flex-column p-3">
            <a href="{{ route('admin.profile.index') }}"
                class="nav-link py-2 px-3 mb-2 rounded {{ request()->routeIs('admin.profile.index') ? 'active' : 'inactive' }}">
                <i class="fas fa-user me-2"></i> Profile
            </a>
            <a href="{{ route('admin.dashboard') }}"
                class="nav-link py-2 px-3 mb-2 rounded {{ request()->routeIs('admin.dashboard') ? 'active' : 'inactive' }}">
                <i class="fas fa-home me-2"></i> Dashboard
            </a>
            <a href="{{ route('admin.about.indexForAdmin') }}"
                class="nav-link py-2 px-3 mb-2 rounded {{ request()->routeIs('admin.about.indexForAdmin') ? 'active' : 'inactive' }}">
            ...
            <a href="{{ route('admin.menu.index') }}"
                class="nav-link py-2 px-3 mb-2 rounded {{ request()->routeIs('admin.menu.index') ? 'active' : 'inactive' }}">
                <i class="fas fa-utensils me-2"></i> Menu Items
            </a>
            <a href="{{ route('admin.offers.index') }}"
                class="nav-link py-2 px-3 mb-2 rounded {{ request()->routeIs('admin.offers.index') ? 'active' : 'inactive' }}">
