...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'category_id' => 'التصنيف',
        'price' => 'السعر',
        'description_en' => 'الوصف باللغة الإنكليزية',
        ...
        'from_date' => 'من تاريخ',
        'to_date' => 'إلى تاريخ',
        'address_ar' => 'عنوان المطعم باللغة العربية',
        'address_en' => 'عنوان المطعم باللغة الإنكليزية',
        'opening_hours' => 'ساعات العمل',
        'facebook_url' => 'رابط حساب فيسبوك',
        'instagram_url' => 'رابط حساب انستغرام',
        'whatsapp' => 'واتساب',
        'logo' => 'لوغو',
        'favicon' =>'ايقونة نافذة المتصفح',
    ],
